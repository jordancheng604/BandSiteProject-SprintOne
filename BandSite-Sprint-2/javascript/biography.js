...
let input2 = event.target.textArea.value;
name1.innerText=input;
name2.innerText=input2;
let list = document.getElementById('commentList');
list.appendChild(name1);
list.appendChild(name2);
document,this.querySelector('input', 'input2').value = "";
// document,this.querySelector('input2').value = "";
